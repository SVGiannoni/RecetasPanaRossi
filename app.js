/**
 * RecetasPanaRossi - Módulo de Validación, Persistencia y Búsqueda (RF-01, RF-02, HU-02)
 */
...
if (typeof document !== 'undefined') {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCatalog() {
      ...
      // Aplicar filtro de búsqueda por palabra clave / ingrediente
      ...
      if (recipes.length === 0) {
        catalogContainer.innerHTML = `
          <div class="preview-empty">
            ...
            <p>${searchQuery.trim().length > 0
              ? 'No se encontraron recetas que coincidan con "' + escapeHtml(searchQuery) + '".'
              : 'No hay recetas publicadas en el catálogo.'}</p>
          </div>
        `;
        return;
      }
