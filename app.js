/**
 * RecetasPanaRossi - Módulo de Validación, Persistencia, Búsqueda, Filtros y Favoritos (RF-01, RF-02, HU-02, HU-03)
 */
...
if (typeof document !== 'undefined') {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCatalog() {
      ...
      // Adjuntar event listeners a los botones de favoritos
